...
// Settings 
app.set('port', process.env.PORT || 3100);                // el process.env sirva para decirle que si hay uno disponible lo tome o sino el que le declaro
...
app.use(cors()); // para que puedan hacer peticiones desde cualquier lado
